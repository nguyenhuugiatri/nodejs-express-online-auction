...
module.exports = {
  getProductByID: id => db.load(`select p.name as name , p.startDate ,p.endDate , p.currentPrice , u.fullname , p.buynowPrice, p.details from product as p,user as u , image i where u.id = p.id_seller and p.id = i.id_product and p.id ='${id}'`),
